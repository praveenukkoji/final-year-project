...
Step 1: extract dataset in current directory.<br />
Step 2: create py environment and install req.txt.<br />
Step 3: run jupyter notebook < Plant Disease Classification.ipynb >.<br />
Step 4: two *.pkl file will be created those are trained model.<br />
Step 5: run jupyter notebook < Testing Model.ipynb >.<br />
